...
{ 
    ...
    { 
        ...
        enum e_DOTW : uint8_t
        {
            DOTW_SUN = 0x0, // indicating Sunday.    // ���� 
            DOTW_MON = 0x1, // indicating Monday.    // ��  
            DOTW_TUE = 0x2, // indicating Tuesday.   // �����  
            DOTW_WED = 0x3, // indicating Wednesday. // ��   
            DOTW_THU = 0x4, // indicating Thursday.  // �����  
            DOTW_FRI = 0x5, // indicating Friday.    // ���� 
            DOTW_SAT = 0x6  // indicating Saturday.  // ������� 
        };
        ...
        inline AM335x_RTC_Type * AM335X_RTC = reinterpret_cast<AM335x_RTC_Type *>(AM335x_RTC_BASE);
