...
namespace REGS
{
    namespace GPIO
    {
        ...
        *               A read of the GPIO_SETDATAOUT register returns the value of the data output register (GPIO_DATAOUT). 
        ...
        inline AM335x_GPIO_Type *AM335x_GPIO_0 = reinterpret_cast<AM335x_GPIO_Type *>(AM335x_GPIO_0_BASE);
        inline AM335x_GPIO_Type *AM335x_GPIO_1 = reinterpret_cast<AM335x_GPIO_Type *>(AM335x_GPIO_1_BASE);
        inline AM335x_GPIO_Type *AM335x_GPIO_2 = reinterpret_cast<AM335x_GPIO_Type *>(AM335x_GPIO_2_BASE);
        inline AM335x_GPIO_Type *AM335x_GPIO_3 = reinterpret_cast<AM335x_GPIO_Type *>(AM335x_GPIO_3_BASE);
